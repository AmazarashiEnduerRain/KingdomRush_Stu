...
void Road::setRoadReady(){
	...
	if(hasDone != 0){
		for(int i = 0;i <= hasDone - 1;i++) roadVector.at(i)->setVisible(true);
	}
}
...
void Road::initRoadAnimation(){
	...
	for (int len = 1;len <= 7; len++){
		...
		if(frame0 != nullptr) aFrames0.pushBack(frame0);
	}
	...
	for (int len = 1;len <= 13; len++){
		...
		if(frame1 != nullptr) aFrames1.pushBack(frame1);
	}
	...
	for (int len = 1;len <= 12; len++){
		...
		if(frame2 != nullptr) aFrames2.pushBack(frame2);
	}
	...
	for (int len = 1;len <= 21; len++){
		...
		if(frame3 != nullptr) aFrames3.pushBack(frame3);
	}
	...
	for (int len = 1;len <= 141; len++){
		...
		if(frame4 != nullptr) aFrames4.pushBack(frame4);
	}
	...
	for (int len = 1;len <= 25; len++){
		...
		if(frame5 != nullptr) aFrames5.pushBack(frame5);
	}
	...
	for (int len = 1;len <= 25; len++){
		...
		if(frame6 != nullptr) aFrames6.pushBack(frame6);
	}
	...
	for (int len = 1;len <= 22; len++){
		...
		if(frame7 != nullptr) aFrames7.pushBack(frame7);
	}
	...
	for (int len = 1;len <= 22; len++){
		...
		if(frame8!=nullptr) aFrames8.pushBack(frame8);
	}
	...
	for (int len = 1;len <= 10; len++){
		...
		if(frame9 != nullptr) aFrames9.pushBack(frame9);
	}
	...
	for (int len = 1;len <= 13; len++){
		...
		if(frame10 != nullptr) aFrames10.pushBack(frame10);
	}
	...
	for (int len = 1;len <= 10; len++){
		...
		if(frame11 != nullptr) aFrames11.pushBack(frame11);
	}
	...
	for (int len = 1;len <= 7; len++){
		...
		if(frame12 != nullptr) aFrames12.pushBack(frame12);
	}
	...
	for (int len = 1;len <= 7; len++){
		...
		if(frame13 != nullptr) aFrames13.pushBack(frame13);
	}
