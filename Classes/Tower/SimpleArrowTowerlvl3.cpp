...
void SimpleArrowTowerlvl3::showUpdateMenu(){
	auto updatePanleLayer = UpdatePanleLayer2::createPanle(25,26,230,230);//数字为编号
	...
	if(GameManager::getInstance()->LEVEL <= 2) updatePanleLayer->couldUpdate1 = false;
	if(GameManager::getInstance()->LEVEL <= 3) updatePanleLayer->couldUpdate2 = false;
